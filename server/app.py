...
async def generate_chat_responses(message: str, checkpoint_id: Optional[str] = None):
    ...
    async for event in events:
        ...
        if event_type == "on_chat_model_stream":
            ...
            search_calls = [call for call in tool_calls if call["name"] in ["tavily_search_results_json", "tavily_search"]]
        ...
        elif event_type == "on_tool_end" and event["name"] in ["tavily_search_results_json", "tavily_search"]:
